-- ============================================================================
-- AXIONBANK CUSTOMER CARE DATA SETUP SCRIPT FOR POSTGRESQL
-- ============================================================================
-- Execute this script in your PostgreSQL database after the server starts
-- Database: AxionBank (localhost:5433)
-- User: postgres
-- Password: Andama@95
...
(gen_random_uuid(), 'SAVINGS', 'Personal Savings Account',
...
(gen_random_uuid(), 'CHECKING', 'Personal Checking Account',
...
(gen_random_uuid(), 'BUSINESS_CHECKING', 'Business Checking Account',
...
(gen_random_uuid(), 'BUSINESS_SAVINGS', 'Business Savings Account',
...
(gen_random_uuid(), 'PREMIUM_CHECKING', 'Premium Checking Account',
...
(gen_random_uuid(), 'STUDENT_CHECKING', 'Student Checking Account',
...
(gen_random_uuid(), 'MONEY_MARKET', 'Money Market Account',
...
VALUES
-- Customer 1: John Doe
(gen_random_uuid(), 'CUST001', 'john_doe',
 '$2a$10$N.zmdr9k7uOa4YLHOy1g6.ILwB8Qk7rCXqrBqyG8wGw6FTFyKh5Je', -- password: password123
 'INDIVIDUAL', 'ACTIVE', 'John', 'Doe', 'Michael', '1985-06-15'::date,
...
(gen_random_uuid(), 'CUST002', 'jane_smith',
 '$2a$10$N.zmdr9k7uOa4YLHOy1g6.ILwB8Qk7rCXqrBqyG8wGw6FTFyKh5Je', -- password: password123
 'INDIVIDUAL', 'ACTIVE', 'Jane', 'Smith', 'Elizabeth', '1990-03-22'::date,
...
(gen_random_uuid(), 'CUST003', 'bob_johnson',
 '$2a$10$N.zmdr9k7uOa4YLHOy1g6.ILwB8Qk7rCXqrBqyG8wGw6FTFyKh5Je', -- password: password123
 'BUSINESS', 'ACTIVE', 'Bob', 'Johnson', NULL, '1978-11-08'::date,
...
(gen_random_uuid(), 'CUST004', 'alice_brown',
 '$2a$10$N.zmdr9k7uOa4YLHOy1g6.ILwB8Qk7rCXqrBqyG8wGw6FTFyKh5Je', -- password: password123
 'INDIVIDUAL', 'ACTIVE', 'Alice', 'Brown', 'Marie', '1992-07-14'::date,
...
(gen_random_uuid(), 'CUST005', 'charlie_wilson',
 '$2a$10$N.zmdr9k7uOa4YLHOy1g6.ILwB8Qk7rCXqrBqyG8wGw6FTFyKh5Je', -- password: password123
 'BUSINESS', 'ACTIVE', 'Charlie', 'Wilson', 'Robert', '1980-12-03'::date,
...
SELECT 'Customer care data setup completed successfully!' AS status,
       (SELECT COUNT(*) FROM account_types)               AS account_types_created,
       ...
       (SELECT COUNT(*) FROM service_requests)            AS service_requests_created;